...
namespace TosrIntegration.Test
{
    ...
    public class TestCaseProviderRelayBid
    {
        public static IEnumerable<object[]> TestCases()
        {
            ...
            yield return new object[] { "TestFit20HCP", "AQ32,A432,A2,AQ2", "xx,xxxx,KQxxx,Kx", "1♣1NT2♦2♠3♦4♦Pass", "1♠2♣2♥3♣3♥4♥Pass" };
            yield return new object[] { "TestFit23HCP", "AQ32,AK32,A2,AQ2", "xx,xxxx,KQxxx,Kx", "1♣1NT2♦2♠3♦3♠4♣4♠5♣5NT6♦Pass", "1♠2♣2♥3♣3♥3NT4♥4NT5♠6♣6♥" };
            ...
            // TODO This is a bug. Test are flaky for some reason
            //yield return new object[] { "TestFitPull20HCPMin", "AQ32,A432,A2,AQ2", "xx,Kxxx,KQxxx,Kx", "1♣1NT2♦2♠3♦4♦4NT5♠6♥6NTPass", "1♠2♣2♥3♣3♥4♠5♥6♦6♠7♣" };
            //yield return new object[] { "TestFitPull20HCPMax", "AQ32,A432,A2,AQ2", "Kx,Kxxx,KQxxx,Kx", "1♣1NT2♦2♠3♦4♣5♥5NT7♦", "1♠2♣2♥3♣3♠5♦5♠6♣" };
            //yield return new object[] { "TestFitPull23HCP", "AQ32,AK32,A2,AQ2", "xx,xxxx,KQxxx,Kx", "1♣1NT2♦2♠3♦3♠4♣4♠5♣5NT6♦Pass", "1♠2♣2♥3♣3♥3NT4♥4NT5♠6♣6♥" };
