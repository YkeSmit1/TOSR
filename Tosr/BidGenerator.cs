...
namespace Tosr
{
    public class BidGenerator : IBidGenerator
    {
        ...
        {
            var bidFromRule = Pinvoke.GetBidFromRule(biddingState.Fase, biddingState.PreviousFase, handsString, biddingState.NextBidIdForRule, out var nextfase, out var zoom);
