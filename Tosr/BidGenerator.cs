...
namespace Tosr
{
    class BidGenerator : IBidGenerator
    {
        ...
        {
            var bidFromRule = Pinvoke.GetBidFromRule(biddingState.fase, handsString, biddingState.relLastBidId, out var nextfase);
    ...
    class BidGeneratorDescription : IBidGenerator
    {
        public (int, Fase, string) GetBid(BiddingState biddingState, string handsString)
        {
            ...
            var bidFromRule = Pinvoke.GetBidFromRuleEx(biddingState.fase, handsString, biddingState.relLastBidId, out var nextfase, description);
